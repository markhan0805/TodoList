    ...
    return (
        <div className="flex flex-col justify-center ml-3">
            ...
            <label className="relative cursor-pointer p-2" htmlFor="light-switch">
                <svg
                    className={`transition duration-300 ${darkMode ? "hidden" : "block"}`}
                    width="16"
                    height="16"
                ...
                <svg className={`transition duration-300 ${darkMode ? "block" : "hidden"}`} width="16" height="16" xmlns="http://www.w3.org/2000/svg">
